...
|---------|------|-------------|
| 4.6.0 | 2026-03-23 | Telegram channel: long-polling bot bridge (`supervisor/telegram_bridge.py`); mirror assistant replies to Telegram; token + allowed chat IDs in Settings UI; TELEGRAM_BOT_TOKEN / TELEGRAM_ALLOWED_CHAT_IDS in config. |
